                                    ...
                                    <form action="{{ route('users.store') }}" method="post">
                                        ...
                                        <div class="relative mb-4">
                                            ...
                                            <input type="number" id="order_amount" name="order_amount"
                                                class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                                required>
                                            <label for="order_date" class="leading-7 text-sm text-gray-600">納期</label>
                                        ...
                                        <input type="submit" value="登録"
                                            class="w-full bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded mt-4">
                                    </form>
                                </div>
                            </div>
                        </div>
